...
class TJ_Core_Plugin {
	...
	public function tj_core_elementor_category($manager) {
		$manager->add_category(
			'tjcore',
			array(
				'title' => esc_html__('SS Addons', 'tjcore'),
				'icon' => 'eicon-banner',
			)
		);
	}
	...
	public function tj_add_custom_icons_tab($tabs = array()) {
		...
		$tabs['fontawesome-light'] = array(
			...
			'label'         => esc_html__('SS Font Awesome - Light', 'tjcore'),
		...
		$tabs['elementor'] = array(
			'name'          => 'elementor',
			'label'         => esc_html__('SS Elementor', 'tjcore'),
		...
		$tabs['feather'] = array(
			'name'          => 'feather',
			'label'         => esc_html__('SS Feather', 'tjcore'),
		...
		$tabs['material-design'] = array(
			...
			'label'         => esc_html__('SS Material Design Icons', 'tjcore'),
