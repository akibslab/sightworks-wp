...
/**
 * Plugin Name: SS Core for Elementor
 * Description: SecureSofts elementor core plugin.
 * Plugin URI:  http://securesofts.com/
 * Version:     1.0.0
 * Author:      SecureSofts
 * Author URI:  http://securesofts.com/
 * Text Domain: tjcore
...
final class TJ_Core {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__('SS Core', 'tjcore') . '</strong>',
