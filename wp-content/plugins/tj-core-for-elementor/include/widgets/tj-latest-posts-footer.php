...
add_action('widgets_init', 'TJ_Latest_Posts_Footer_Widget');
function TJ_Latest_Posts_Footer_Widget() {
	register_widget('TJ_Latest_Posts_Footer_Widget');
}


class TJ_Latest_Posts_Footer_Widget extends WP_Widget {

	public function __construct() {
		parent::__construct('tj-latest-posts-footer', 'SS Footer Posts', array(
	...
	public function widget($args, $instance) {
		...
		<div class="tj-footer-news">
			...
			?>
					<div class="tj-footer-news-single mb-15">
	...
	public function form($instance) {
		...
		$choose_style = !empty($instance['choose_style']) ? $instance['choose_style'] : esc_html__('style_1', 'tjcore');
	?>
		<p>
