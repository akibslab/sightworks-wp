...
class TJ_Contact_Info_Widget  extends WP_Widget {
	...
	public function __construct() {
		parent::__construct('tj_contact_info_widget', esc_html__('SS Contact Info', 'tjcore'), array(
			'description' => esc_html__('SS Contact Info Widget', 'tjcore'),
		));
	}
...
?>
	...
	?>
		...
		<p>
			<label for="title"><?php esc_html_e('Address:', 'tjcore'); ?></label>
		</p>
		...
		<p>
			<label for="title"><?php esc_html_e('Email Address:', 'tjcore'); ?></label>
		</p>
		...
		<p>
			<label for="title"><?php esc_html_e('Phone Number:', 'tjcore'); ?></label>
		</p>
		...
		<p>
			<label for="title"><?php esc_html_e('Website Url:', 'tjcore'); ?></label>
		</p>
