...
add_action('widgets_init', 'Tj_Services_List_Widget');
function Tj_Services_List_Widget() {
	register_widget('Tj_Services_List_Widget');
}
class Tj_Services_List_Widget extends WP_Widget {

	public function __construct() {
		parent::__construct('tj-services-list', 'SS Services List', array(
