...
add_action('widgets_init', 'TJ_Subscriber2_Widget');
function TJ_Subscriber2_Widget() {
	register_widget('TJ_Subscriber2_Widget');
}

class TJ_Subscriber2_Widget  extends WP_Widget {

	public function __construct() {
		parent::__construct('TJ_Subscriber2_Widget', esc_html__('SS Footer Subscriber 2', 'tjcore'), array(
...
?>
		...
		<div class="tj-footer-subscribe-area-two position-relative pt-100">
			<div class="container">
				<div class="tj-footer-subscribe-bg-two theme-yellow-bg pt-30 pb-20 z-index pl-60 pr-60">
					<div class="row align-items-center">
						...
						<?php if (!empty($mailchimp_shortcode)) : ?>
							<div class="col-xl-7 col-lg-8">
								<div class="tj-footer-subscribe-form tj-footer-subscribe-form-2">
