...
add_action('widgets_init', 'TJ_Info_Widget');
function TJ_Info_Widget() {
	register_widget('TJ_Info_Widget');
}


class TJ_Info_Widget  extends WP_Widget {

	public function __construct() {
		parent::__construct('TJ_Info_Widget', esc_html__('Zibber Info', 'tjcore'), array(
			'description' => esc_html__('SS Info Widget', 'tjcore'),
		));
	}
...
?>
	...
	?>
		...
		<p>
			<label for="title"><?php esc_html_e('Short Description:', 'tjcore'); ?></label>
		</p>
