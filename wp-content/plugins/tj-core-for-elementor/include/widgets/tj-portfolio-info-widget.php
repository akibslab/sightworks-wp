...
add_action('widgets_init', 'TJ_Portfolio_Info_Widget');
function TJ_Portfolio_Info_Widget() {
	register_widget('TJ_Portfolio_Info_Widget');
}

class TJ_Portfolio_Info_Widget  extends WP_Widget {

	public function __construct() {
		parent::__construct('TJ_Portfolio_Info_Widget', esc_html__('SS Portfolio Info', 'tjcore'), array(
			'description' => esc_html__('SS Portfolio Info Widget', 'tjcore'),
		));
	}
