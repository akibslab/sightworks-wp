...
?>
    ...
    <?php if (!empty(($content_block_1['block_title'] || $content_block_1['block_text']) || ($content_block_2['block_title'] || $content_block_2['block_text']) || ($content_block_3['block_title'] || $content_block_3['block_text']))) : ?>
