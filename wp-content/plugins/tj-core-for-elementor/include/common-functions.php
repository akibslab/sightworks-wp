...
if (!function_exists('tj_get_post_types')) {
    function tj_get_post_types() {
        ...
        $tj_cpts = get_post_types(array('public' => true, 'show_in_nav_menus' => true), 'object');
        $tj_exclude_cpts = array('elementor_library', 'attachment');
 ...
 */
if (!function_exists('tj_get_post_settings')) {
    function tj_get_post_settings($settings) {
 ...
 * Slugify
 */
if (!function_exists('tj_slugify')) {
    function tj_slugify($text) {
