...
$author_info = get_the_author_meta('sightworks_write_by');
$facebook_url = get_the_author_meta('sightworks_facebook');
$twitter_url = get_the_author_meta('sightworks_twitter');
$linkedin_url = get_the_author_meta('sightworks_linkedin');
$instagram_url = get_the_author_meta('sightworks_instagram');
$sightworks_url = get_the_author_meta('sightworks_youtube');
$sightworks_write_by = get_the_author_meta('sightworks_write_by');
