...
$sightworks_video_url = function_exists('get_field') ? get_field('fromate_style') : NULL;
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('ss__post format-video'); ?>>
        <?php if (has_post_thumbnail()) : ?>
            <div class="ss-feature__image">
                ...
                <?php if (!empty($sightworks_video_url)) : ?>
                    <div class="ss-post__video ss-video-btn__style">
                        <a href="<?php print esc_url($sightworks_video_url); ?>" class="popup-video"><i class="fa-solid fa-play"></i></a>
                    <?php endif; ?>
                    </div>
            </div>
        <?php endif; ?>
